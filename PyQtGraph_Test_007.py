...
This code is a modifications of the running version of "PyQtGraph_Test_006.py".
In this code I'm trying to achive send more complicated torque reference commands
through the GUI (like sinwaves).
The idea is to write the function directly in the textbox and make the program
recognize it and process it, so a trigonoetric or polynomial can be send (constants values too).
...
1. The unecessary commented code was removed
2. The declaration of global variables was improved
