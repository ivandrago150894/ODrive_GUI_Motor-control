...
This code is a modifications of the running version of "PyQtGraph_Test_003.py".
In this code I'm trying to solve the freezeng problem and also improve the Layout methods
implemented to add a button that allows save the real-time data.

2023/12/07 ==>  The freezeing problem has been solved.
                Now, the app is more stable and can handle resizing and dragging.
...
class MainWindow(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        global win_size, t_buffer, tau_d_buffer, tau_buffer, current_buffer, voltage_buffer, pos_buffer, start_time
        ...
        Left_VLayout.addWidget(QPushButton("Left Top Button"))
        Left_VLayout.addWidget(QPushButton("Left Mid Button"))
        Left_VLayout.addWidget(QPushButton("Start data Logging"))
            # Widgets in the center vert. layout
        Center_VLayout.addWidget(QPushButton("Center Top Button"))
