...
This code is a modifications of the running version of "PyQtGraph_Test_004.py".
In this code I'm trying to achive data logging (save the real-time data into a csv file) when
a button is clicked.

2023/12/08 ==>  Now there is a fully working button in the left-bottom corner that allows to perform data loggin.
...
class MainWindow(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        global win_size, t_buffer, tau_d_buffer, tau_buffer, current_buffer, voltage_buffer, pos_buffer, t_0, t_minus_1, LoggingButton
